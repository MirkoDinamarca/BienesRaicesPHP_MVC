<main class="contenedor seccion menu-nosotros">
    ...
    <div class="nosotros">
        <div class="imagen-nosotros">
            <picture>
                ...
                <img loading="lazy" srcset="build/img/nosotros.jpg" src="" alt="Imagen Nosotros">
            </picture>
        </div>
        ...
        <div class="info-nosotros">
            ...
            <p>Proin consequat viverra sapien, malesuada tempor tortor feugiat vitae.
                ...
                Suspendisse lobortis dolor quis elit suscipit molestie. Sed condimentum, erat at tempor finibus, urna nisi fermentum est,
                a dignissim nisi liberovel est. Donec et imperdiet augue. Curabitur malesuada sodales congue.
                Suspendisse potenti. Ut sit amet convallis nisi.
            </p>

            <p>
                Aliquam lectus magna, luctus vel gravida nec, iaculis ut augue.
                Praesent ac enim lorem. Quisque ac dignissim sem, non condimentum orci.
                Morbi a iaculis neque, ac euismod felis.
                Fusce augue quam, fermentum sed turpis nec, hendrerit dapibus ante.
